...
const MusicCard = ({ id }) => {
  return (
    <>
      <button
        className="h-40 sm:!h-48 bg-[#181818] rounded-lg px-2 pt-2 pb-1 md:h-56 hover:bg-[#272727] transition-all duration-300 cursor-pointer songCart text-left lg:!text-center hover:scale-105"
        key={id}
      >
