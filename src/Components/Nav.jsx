  ...
  return (
    <>
      ...
      >
          ...
          <div className="grid grid-cols-12 lg:block items-center justify-between mb-5 lg:!mb-0">
            ...
            <div className="w-full col-span-10">
              <div className="w-full flex items-center relative pl-4 pr-3 lg:!p-0">
                <input
                  type="search"
                  className="relative lg:!h-12 focus:border-2 focus:!bg-neutral-700 pb-1 w-full pl-4 xl:pl-6 h-11 rounded-xl hover:bg-stone-800/60 bg-stone-800 placeholder:text-xs md:placeholder placeholder:text-stone-300 dark:placeholder:text-stone-500 text-white"
        ...
        >
          <button className="w-1/5 lg:w-1/4 mx-2 h-8 sm:!h-10 hover:bg-stone-500 !bg-blue-800 text-white rounded-md flex items-center justify-center shadow-[0_0_12px_blue]">
            Playlist
          </button>
          <button className="w-1/5 lg:w-1/4 mx-2 h-8 sm:!h-10 text-stone-300 hover:bg-stone-500 bg-stone-600 rounded-md flex items-center justify-center">
            Artists
          </button>
          <button className="w-1/5 lg:w-1/4 mx-2 h-8 sm:!h-10 text-stone-300 hover:bg-stone-500 bg-stone-600 rounded-md flex items-center justify-center">
            Podcasts
