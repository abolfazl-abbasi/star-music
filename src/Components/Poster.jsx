const Poster = ({ id, col }) => {
  return (
    <>
      <button
        className={`col-span-1 lg:!col-span-${col} bg-black h-20 rounded-lg lg:!rounded-none p-2 lg:!p-0 flex items-center sm:!h-28 md:!h-32 cursor-pointer sectionTitle`}
        key={id}
      >
        <img
