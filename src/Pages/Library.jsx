    ...
    <div className="space-y-2">
      <div>
        ...
        <div className="grid grid-cols-2 lg:!grid-cols-10 w-full gap-2 md:!gap-3 px-2 py-1">
          ...
          <button className="col-span-1 bg-black h-20 rounded-lg lg:!rounded-none p-2 lg:!p-0 flex items-center sm:!h-28 md:!h-44 cursor-pointer sectionTitle hover:!bg-purple-900">
      ...
      <div>
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:!grid-cols-5 xl:!grid-cols-8 w-full gap-4 md:gap-5 px-2 py-1">
          {_.range(0, 8).map((id) => (
            <button
